...
```{r daily_totals_hist}
hist(daily_totals$total)
```

The mean number of steps is `r format(mean(daily_totals$total), scientific=F, big.mark=",")`.  

The median number of steps is `r format(median(daily_totals$total), scientific=F, big.mark=",")`.  
